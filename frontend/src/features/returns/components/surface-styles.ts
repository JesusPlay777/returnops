...
export const customerSurfaceStyles = {
  ...
  headerTools: "flex items-center gap-[18px] max-[420px]:gap-2",
  ...
  sessionCard:
    "grid grid-cols-[40px_1fr] items-start gap-[14px] rounded-[18px] border border-border-strong bg-surface/70 p-[22px] backdrop-blur-[12px] data-[status=waking]:border-warning data-[status=error]:border-danger max-[900px]:max-w-[540px]",
  ...
  errorState:
    "mt-8 flex min-h-[170px] items-center justify-between gap-6 rounded-2xl border border-dashed border-danger/40 bg-danger-soft p-6",
  detailHeader:
  ...
  detailMeta:
    "mt-9 grid grid-cols-4 gap-7 rounded-[15px] bg-surface-muted p-6 max-[900px]:grid-cols-2 max-[620px]:grid-cols-1 max-[620px]:p-5",
  detailGrid:
  ...
  orderResultButton:
    "grid min-h-[70px] cursor-pointer grid-cols-[1fr_auto_22px] items-center gap-[18px] rounded-xl border border-border bg-surface-subtle px-4 py-[13px] text-left text-ink hover:border-primary hover:bg-primary-soft",
  selectedOrder:
    "flex items-center justify-between gap-[18px] rounded-[13px] border border-primary/35 bg-primary-soft p-4",
  catalogItems: "grid gap-[10px]",
  catalogItemCard:
    "overflow-hidden rounded-[13px] border border-border bg-surface data-[selected=true]:border-primary",
  catalogItemHeader:
    "grid min-h-[72px] cursor-pointer grid-cols-[22px_1fr_auto] items-center gap-3 px-[15px] py-[13px]",
  catalogItemFields:
    "grid grid-cols-[130px_minmax(190px,1fr)] gap-3 border-t border-border bg-surface-subtle px-[15px] pt-[14px] pb-4 pl-[49px] max-[620px]:grid-cols-1 max-[620px]:pl-[15px]",
  formError:
  ...
  toast:
    "fixed right-6 bottom-6 z-30 flex min-h-[54px] items-center gap-[10px] rounded-xl border border-success/35 bg-surface py-0 pr-3 pl-[17px] text-[12px] font-[680] text-success shadow-surface max-[620px]:right-4 max-[620px]:bottom-4 max-[620px]:left-4",
} as const;
...
export const workflowSurfaceStyles = {
  ...
  header:
    "flex min-h-[68px] items-center gap-[14px] bg-[linear-gradient(135deg,#0f766e,#087f78)] px-[clamp(20px,5vw,40px)] text-[#eef7f5] max-[640px]:min-h-[62px]",
  workflowHeader:
  ...
  itemForm:
    "mt-7 rounded-2xl border border-border-strong bg-surface p-6 shadow-surface",
  ...
  evidenceCard:
    "grid min-h-[175px] content-start gap-3 rounded-xl border border-border bg-surface-subtle p-4 data-[attached=true]:border-primary data-[attached=true]:bg-primary-soft max-[640px]:min-h-[128px] max-[640px]:grid-cols-[38px_1fr]",
  reviewCard:
  ...
  responseNote:
    "mt-5 grid gap-[7px] rounded-[13px] border border-warning/45 bg-warning-soft p-5 text-[10px] font-bold text-ink",
  confirmation:
  ...
  warning:
    "grid grid-cols-[28px_1fr] items-center gap-[10px] rounded-b-[13px] border border-t-0 border-warning/45 bg-warning-soft px-[19px] py-[17px] text-[11px] leading-normal text-warning",
  error:
    "relative mb-[22px] grid grid-cols-1 gap-1 rounded-[10px] border border-danger/45 bg-danger-soft py-[14px] pr-[46px] pl-4 text-[11px] text-danger",
  footer:
    "sticky bottom-0 z-[2] grid min-h-[84px] grid-cols-[1fr_1.3fr] items-center gap-[14px] border-t border-border bg-surface/95 px-[clamp(20px,6vw,48px)] py-4 backdrop-blur-[10px]",
} as const;
...
export const operationsSurfaceStyles = {
  ...
  topbar:
    "flex min-h-[78px] items-center justify-end gap-6 border-b border-border bg-surface/90 px-[clamp(28px,5vw,70px)] backdrop-blur-[10px] max-[760px]:sticky max-[760px]:top-0 max-[760px]:z-[5] max-[760px]:min-h-16 max-[760px]:gap-[10px] max-[760px]:border-b-0 max-[760px]:bg-[linear-gradient(100deg,#087c75,#006c67)] max-[760px]:px-[18px] max-[760px]:text-[#eef7f5] max-[420px]:overflow-x-auto",
  main:
  ...
  expandedPanel:
    "overflow-hidden rounded-[10px] border border-border-strong bg-surface max-[760px]:rounded-none max-[760px]:border-x-0 max-[760px]:border-b-0",
  expandedHeader:
  ...
  expandedItem:
    "grid min-h-[92px] grid-cols-[46px_minmax(0,1fr)_auto] items-center gap-[14px] border-b border-border py-4 last:border-b-0 max-[760px]:grid-cols-[42px_1fr]",
  ...
  errorState:
    "flex min-h-[180px] items-center justify-between gap-3 rounded-b-xl border border-t-0 border-danger/40 bg-danger-soft p-6 text-[12px] text-text-secondary",
  pagination:
    "mt-[18px] grid grid-cols-[1fr_auto_1fr] items-center gap-4 max-[760px]:mb-5",
  toast:
    "fixed right-6 bottom-6 z-20 flex min-h-[50px] items-center gap-[10px] rounded-[10px] border border-success/35 bg-surface py-0 pr-[10px] pl-4 text-[11px] font-bold text-success shadow-surface max-[760px]:right-[14px] max-[760px]:bottom-[14px] max-[760px]:left-[14px]",
} as const;
...
export const reviewSurfaceStyles = {
  ...
  dialog:
    "max-h-[calc(100vh-56px)] w-[min(1180px,100%)] overflow-hidden rounded-[18px] border border-border-strong bg-canvas shadow-[0_30px_90px_rgb(0_0_0_/_35%)] max-[900px]:max-h-[calc(100vh-28px)] max-[560px]:max-h-screen max-[560px]:w-full max-[560px]:rounded-none max-[560px]:border-0",
  header:
  ...
  evidenceCard:
    "flex min-w-0 items-center gap-[9px] rounded-lg border border-border bg-surface-subtle p-[10px]",
  itemTitle:
  ...
  confirmation:
    "mt-[14px] rounded-[9px] border border-warning/45 bg-warning-soft p-[13px]",
  actionError:
    "mt-[14px] rounded-[9px] border border-danger/40 bg-danger-soft p-[13px]",
  readOnlyPanel:
    "rounded-[11px] border border-warning/45 bg-warning-soft px-[18px] py-6 text-center data-[status=APPROVED]:border-success/45 data-[status=APPROVED]:bg-success-soft data-[status=REJECTED]:border-danger/45 data-[status=REJECTED]:bg-danger-soft",
} as const;
