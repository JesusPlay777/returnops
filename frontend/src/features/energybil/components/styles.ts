...
export const energySurfaceStyles = {
  ...
  scenarioCard:
    "relative overflow-hidden rounded-[28px] border border-[#bfd8d3] bg-primary p-[clamp(26px,4vw,38px)] text-surface shadow-[0_28px_80px_rgb(15_118_110_/_20%)] before:absolute before:-top-16 before:-right-16 before:size-48 before:rounded-full before:border before:border-white/20 after:absolute after:-right-7 after:-bottom-16 after:size-36 after:rounded-full after:bg-white/5",
  scenarioGrid: "relative z-10 mt-8 grid grid-cols-2 gap-px overflow-hidden rounded-2xl bg-white/20",
  ...
  invoice:
    "mt-6 overflow-hidden rounded-2xl border border-border bg-[#fbfcfb]",
  invoiceHeader:
...
export const energyPatternStyles = {
  ...
  scenarioMetric:
    "[&>span]:block [&>span]:text-[9px] [&>span]:tracking-[0.1em] [&>span]:text-white/60 [&>span]:uppercase [&>strong]:mt-2 [&>strong]:block [&>strong]:text-[17px] [&>strong]:font-[680]",
  sectionTitle:
